...
class DictionaryViewModel: ViewModel() {
    ...
    fun onExampleClicked(word: String, context: Context, currentExample: String) {
        if (currentExample == getDictionaryValueFromXml(context, R.xml.dictionary,word,"exampletranslation")) {
            ...
            _uiState.value = _uiState.value.copy(currentExample = getDictionaryValueFromXml(context,
                R.xml.dictionary,word,"example"))
        } else {
    ...
    fun AppNavigation() {
        ...
        NavHost(navController = navController, startDestination = "home") {
            ...
            composable("details") { WordDetailScreen(dictionaryViewModel, LocalContext.current) }
        }
    }
